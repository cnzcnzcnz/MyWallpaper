package com.abstraksi.btswallpaperhd2020.di
...
import com.abstraksi.btswallpaperhd2020.data.db.AppDatabase
import com.abstraksi.btswallpaperhd2020.data.remote.createWebService
import com.abstraksi.btswallpaperhd2020.data.remote.provideOkHttpClient
import com.abstraksi.btswallpaperhd2020.data.pref.PreferencesHelper
import com.abstraksi.btswallpaperhd2020.data.remote.service.ApiService
import com.abstraksi.btswallpaperhd2020.data.repository.PhotoRepositoryImpl
import com.abstraksi.btswallpaperhd2020.domain.repository.PhotoRepository
import com.abstraksi.btswallpaperhd2020.presentation.viewmodel.PhotoViewModel
import com.abstraksi.btswallpaperhd2020.data.repository.AdsJsonRepositoryImpl
...
import com.abstraksi.btswallpaperhd2020.utils.rx.AppSchedulerProvider
import com.abstraksi.btswallpaperhd2020.utils.rx.SchedulerProvider
